...
Finally we define the function to initilize the mode it self. This is an interactive function taking an optional argument which will default to 'toggle if no argument is passed to it.  CONTINUE HERE.......
